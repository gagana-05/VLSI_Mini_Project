...
# Design libraries
design_libs=(simprims_ver xpm xil_defaultlib microblaze_v11_0_10 lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_21 blk_mem_gen_v8_4_5 axi_lite_ipif_v3_0_4 mdm_v3_2_23 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../NewLorenz.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../NewLorenz.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
