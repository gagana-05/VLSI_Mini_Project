...
HD_PWD='c:/users/gagan/desktop/vivstuff/ip_repo/edit_myip_lorenz_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_lorenz_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_lorenz_v1_0.tcl
