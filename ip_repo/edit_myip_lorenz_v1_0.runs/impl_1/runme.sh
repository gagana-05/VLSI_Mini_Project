...
HD_PWD='c:/users/gagan/desktop/vivstuff/ip_repo/edit_myip_lorenz_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_lorenz_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myip_lorenz_v1_0.tcl -notrace
